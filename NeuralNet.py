...
class NeuralNet:
    ...
    def train(self, activation, max_iterations = 1000, learning_rate = 0.05):
        ...
        print("Activation function used: " + activation)
 ...
 # use test param or pass the value as X_test and y_test?
...
if __name__ == "__main__":
    ...
    train = "http://archive.ics.uci.edu/ml/machine-learning-databases/car/car.data"
    # train = "http://archive.ics.uci.edu/ml/machine-learning-databases/adult/adult.data"
    neural_network = NeuralNet(train)
    neural_network.train(activation=activation, max_iterations=iterations, learning_rate=learning_rate)
    # testError = neural_network.predict("test.csv")
    testError = neural_network.predict(test=None, activation=activation)
